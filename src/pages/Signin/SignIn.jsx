  ...
  return (
    <div className="xl:flex h-screen bg-bg1">
      <div className="xl:w-[719.988px] hidden xl:inline-block">
        ...
        <a
          href="https://www.linkedin.com/in/priyank384"
          target="_blank"
        ...
        <a
          href="https://discordapp.com/users/priyank384"
          target="_blank"
          rel="noopener noreferrer"
        >
          <img
            className="xl:w-[50px] xl:relative xl:h-[48px]"
            alt="Carbon logo twitter"
            src="./images/Vector4.svg"
          />
        </a>
        <a
          href="https://github.com/Priyank384"
          target="_blank"
          rel="noopener noreferrer"
        >
          <img
            className="xl:w-[44px] xl:relative xl:h-[44px]"
            alt="Carbon logo github"
            src="./images/Vector2.svg"
          />
        </a>
        <a
          href="https://twitter.com/Priyank_384"
          target="_blank"
          rel="noopener noreferrer"
        >
          <img
            className="xl:w-[42px] xl:relative xl:h-[41px]"
